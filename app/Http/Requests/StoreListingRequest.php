...
class StoreListingRequest extends RequestGuard {
    ...
    public function rules() {
        ...
        return [
            ...
            'social_links' => 'required|url|max:255',
    ...
    public function messages() {
        return [
            ...
            'social_links.required' => esc_html__('Website is required.', 'ehx-directorist'),
            'social_links.url' => esc_html__('Website must be a valid URL.', 'ehx-directorist'),
