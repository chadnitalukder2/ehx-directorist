    ...
    public static function getAll($perPage, $page, $search, $category_ids, $tag_ids, $latitude = null, $longitude = null, $distance = null)
{
    ...
    // Base queries with distance calculation if lat/long provided
    if ($latitude > 0 && $longitude > 0 && $distance > 0) {
        ...
        // Original queries without distance
    ...
    // Distance condition
    if ($latitude > 0 && $longitude > 0 && $distance > 0) {
        // Only include listings where distance is less than or equal to specified value
    ...
    // Combine WHERE conditions - changed from OR to AND for proper filtering
